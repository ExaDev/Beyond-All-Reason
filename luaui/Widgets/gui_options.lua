...
if not startScript then
	...
	startScript = [[[game]
	{
		...
		{
			team=0;
			name=]] .. select(1, Engine.Shared.GetPlayerInfo(Engine.Unsynced.GetLocalPlayerID())) .. [[;
		}
		mapname=]] .. Game.mapName .. [[;
		myplayername=]] .. select(1, Engine.Shared.GetPlayerInfo(Engine.Unsynced.GetLocalPlayerID())) .. [[;
		ishost=1;
