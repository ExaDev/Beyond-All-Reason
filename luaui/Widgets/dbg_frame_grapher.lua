...
function widget:Initialize()
	...
	timerstart = Engine.Unsynced.GetTimerMicros()
	timerold = Engine.Unsynced.GetTimerMicros()
end
...
local lastTime = Engine.Unsynced.GetTimerMicros()
...
local function nowEvent(e)
	...
	local nowTime = Engine.Unsynced.GetTimerMicros()
...
function widget:DrawScreen()
  ...
  if fto > 0.99 then
	...
	local shadertime = spDiffTimers(Engine.Unsynced.GetTimerMicros(), timerstart, nil, true) * 1000 -- in MILLISECONDS
