...
for udid, ud in pairs(UnitDefs) do
	...
	if name:find("armgremlin") or name:find("armamb") or name:find("armpb") or name:find("armferret") or name:find("armckfus") or name:find("armsnipe") or name:find("armshockwave") or name:find("eyes") or name:find("mine") or name:find("armcom") or name:find("corcom") or name:find("legcom") then
...
function widget:PlayerChanged(playerID)
	local prevTeam, prevFull = Engine.Unsynced.GetLocalTeamID(), fullview
