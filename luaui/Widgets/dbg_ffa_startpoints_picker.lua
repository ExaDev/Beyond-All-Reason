...
local function isSoloDevMode()
	...
	local teamList = Engine.Shared.GetTeamList(Engine.Unsynced.GetLocalAllyTeamID())
	...
	if not isSolo or not BAR.Utilities.IsDevMode() or Engine.Unsynced.IsReplay() then
		return false
	end
	return true
end
