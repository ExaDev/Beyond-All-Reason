...
local function MakeBloomShaders()
	local viewSizeX, viewSizeY = Engine.Unsynced.GetViewGeometry()
...
function widget:Initialize()
	...
	local hasdeferredmodelrendering = (Engine.Unsynced.GetConfigString("AllowDeferredModelRendering") == "1")
	...
	local hasdeferredmaprendering = (Engine.Unsynced.GetConfigString("AllowDeferredMapRendering") == "1")
