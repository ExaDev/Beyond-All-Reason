...
local function updateRejoin()
	if showRejoinUI and serverFrame then
		...
		dlistRejoin = gl.CreateList(function()
			...
			font2:Print("\255\225\255\225" .. BAR.I18N("ui.rejoin.catchingUp") .. " \255\166\166\166" .. gametime, area[1] + ((area[3] - area[1]) / 2), area[2] + barHeight * 2 + (fontsize * 0.89), fontsize, "cor")
			font2:End()
		end)
	end
end
