...
local function ReloadMusicPlaylists()
	...
	if newSoundtrackEnabled then
		...
		-- April Fools --------------------------------------------------------------------------------------------------------------------
		if BAR.Utilities.Gametype.GetCurrentHolidays().aprilfools and Engine.Unsynced.GetConfigInt("UseSoundtrackAprilFools", 1) == 1 then
		...
		elseif (not BAR.Utilities.Gametype.GetCurrentHolidays().aprilfools) and Engine.Unsynced.GetConfigInt("UseSoundtrackAprilFoolsPostEvent", 0) == 1 then
		...
		-- Halloween --------------------------------------------------------------------------------------------------------------------
		if BAR.Utilities.Gametype.GetCurrentHolidays().halloween and Engine.Unsynced.GetConfigInt("UseSoundtrackHalloween", 1) == 1 then
		...
		elseif (not BAR.Utilities.Gametype.GetCurrentHolidays().halloween) and Engine.Unsynced.GetConfigInt("UseSoundtrackHalloweenPostEvent", 0) == 1 then
		...
		-- Christmas --------------------------------------------------------------------------------------------------------------------
		if BAR.Utilities.Gametype.GetCurrentHolidays().xmas and Engine.Unsynced.GetConfigInt("UseSoundtrackXmas", 1) == 1 then
		...
		elseif (not BAR.Utilities.Gametype.GetCurrentHolidays().xmas) and Engine.Unsynced.GetConfigInt("UseSoundtrackXmasPostEvent", 0) == 1 then
