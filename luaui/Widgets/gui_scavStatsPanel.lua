	...
	if currentTime > gameInfo.scavGracePeriod then
		if gameInfo.scavBossAnger < 100 then
			...
			if Engine.Shared.GetGameRulesParam("ScavBossAngerGain_Base") then
				font:Print(textColor .. BAR.I18N("ui.scavs.bossAngerBase", { value = math.round(Engine.Shared.GetGameRulesParam("ScavBossAngerGain_Base"), 3) }), panelMarginX + 5, PanelRow(3), panelFontSize, "")
				font:Print(textColor .. BAR.I18N("ui.scavs.bossAngerAggression", { value = math.round(Engine.Shared.GetGameRulesParam("ScavBossAngerGain_Aggression"), 3) }), panelMarginX + 5, PanelRow(4), panelFontSize, "")
			...
			if Engine.Shared.GetGameRulesParam("scavBossStaggerActive") == false then
				font:Print(textColor .. BAR.I18N("ui.scavs.bossStaggerPercentage", { count = nBosses, value = 100 - Engine.Shared.GetGameRulesParam("scavBossStaggerPercentage") }), panelMarginX, PanelRow(2), panelFontSize, "")
			else
				font:Print("\255\255\255\0" .. BAR.I18N("ui.scavs.bossStaggerActive", { count = nBosses }), panelMarginX, PanelRow(2), panelFontSize, "")
				font:Print("\255\255\255\0" .. BAR.I18N("ui.scavs.bossStaggerPercentage", { count = nBosses, value = 100 - Engine.Shared.GetGameRulesParam("scavBossStaggerPercentage") }), panelMarginX, PanelRow(3), panelFontSize, "")
			end
			if nBosses > 1 then
