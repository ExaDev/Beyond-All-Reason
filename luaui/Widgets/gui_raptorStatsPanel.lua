	...
	if currentTime > gameInfo.raptorGracePeriod then
		if gameInfo.raptorQueenAnger < 100 then
			...
			if Engine.Shared.GetGameRulesParam("RaptorQueenAngerGain_Base") then
				font:Print(textColor .. BAR.I18N("ui.raptors.queenAngerBase", { value = math.round(Engine.Shared.GetGameRulesParam("RaptorQueenAngerGain_Base"), 3) }), panelMarginX + 5, PanelRow(3), panelFontSize, "")
				font:Print(textColor .. BAR.I18N("ui.raptors.queenAngerAggression", { value = math.round(Engine.Shared.GetGameRulesParam("RaptorQueenAngerGain_Aggression"), 3) }), panelMarginX + 5, PanelRow(4), panelFontSize, "")
			...
			if Engine.Shared.GetGameRulesParam("raptorQueenStaggerActive") == false then
				font:Print(textColor .. BAR.I18N("ui.raptors.queenStaggerPercentage", { count = nBosses, value = 100 - Engine.Shared.GetGameRulesParam("raptorQueenStaggerPercentage") }), panelMarginX, PanelRow(2), panelFontSize, "")
			else
				font:Print("\255\255\255\0" .. BAR.I18N("ui.raptors.queenStaggerActive", { count = nBosses }), panelMarginX, PanelRow(2), panelFontSize, "")
				font:Print("\255\255\255\0" .. BAR.I18N("ui.raptors.queenStaggerPercentage", { count = nBosses, value = 100 - Engine.Shared.GetGameRulesParam("raptorQueenStaggerPercentage") }), panelMarginX, PanelRow(3), panelFontSize, "")
			end
