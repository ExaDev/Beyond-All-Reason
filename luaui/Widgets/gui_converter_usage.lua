...
local function updateUI()
	...
	local tooltipTitle = BAR.I18N("ui.topbar.converter_usage.defaultTooltipTitle")
	local tooltipText = BAR.I18N("ui.topbar.converter_usage.defaultTooltip")
	...
	dlistCU = glCreateList(function()
		...
		if converterUse < 20 then
			...
			tooltipText = tooltipText .. "\n\n\255\255\100\075" .. BAR.I18N("ui.topbar.converter_usage.tooManyConverters1Tooltip") .. "\n\255\255\100\075" .. BAR.I18N("ui.topbar.converter_usage.tooManyConverters2Tooltip")
		elseif converterUse < 40 then
			color = "\255\255\100\000" --Orange
			tooltipText = tooltipText .. "\n\n\255\255\120\050" .. BAR.I18N("ui.topbar.converter_usage.tooManyConverters1Tooltip") .. "\n\255\255\120\050" .. BAR.I18N("ui.topbar.converter_usage.tooManyConverters2Tooltip")
