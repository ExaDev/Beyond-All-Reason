...
local state = {
	...
	myName = Engine.Shared.GetPlayerInfo(Engine.Unsynced.GetLocalPlayerID(), false),
				...
				if inputText ~= "" then
					...
					if ssub(inputText, 1, 1) == "/" then
						...
						if badWord ~= nil and inputText ~= lastMessage then
							addChatLine(Engine.Shared.GetGameFrame(), LineTypes.System, "Moderation", "\255\255\000\000" .. BAR.I18N("ui.chat.moderation.prefix"), BAR.I18N("ui.chat.moderation.blocked", { badWord = badWord }))
						else
...
function widget:Initialize()
	...
	widget:ViewResize()
	widget:PlayerChanged(Engine.Unsynced.GetLocalPlayerID())
