...
local function drawContent()
	...
	local fps = Engine.Unsynced.GetFPS()
...
function widget:Initialize()
	...
	Engine.Unsynced.SendCommands("fps 0")
	Engine.Unsynced.SendCommands("clock 0")
	Engine.Unsynced.SendCommands("speed 0")
end
...
function widget:Shutdown()
	...
	Engine.Unsynced.SendCommands("fps 1")
	Engine.Unsynced.SendCommands("clock 1")
	Engine.Unsynced.SendCommands("speed 1")
	WG.displayinfo = nil
end
