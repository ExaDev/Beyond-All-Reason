		...
		if showEngineTooltip then
			...
			if hoverType == "ground" then
				...
				if displayMapPosition then
					...
					font:Print(tooltipLabelTextColor .. BAR.I18N("ui.info.elevation") .. "  " .. tooltipValueColor .. math.floor(Engine.Shared.GetGroundHeight(coords[1], coords[3])), backgroundRect[1] + contentPadding + (fontSize * 6.6), backgroundRect[4] - contentPadding - (fontSize * 0.8) - height, fontSize, "o")
