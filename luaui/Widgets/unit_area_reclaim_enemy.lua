...
local allyTeam = Engine.Unsynced.GetLocalAllyTeamID()
...
function widget:CommandNotify(id, params, options)
	...
	for i = 1, #areaUnits do
		...
		local enemyUnit = not Engine.Shared.AreTeamsAllied(Engine.Shared.GetUnitTeam(unitID), Engine.Unsynced.GetLocalTeamID())
		if enemyUnit then
