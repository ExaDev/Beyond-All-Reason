...
local function createList(size)
	...
	if WG.tooltip ~= nil then
		WG.tooltip.AddTooltip("clearmapmarks", { xPos - usedImgSize, yPos, xPos, yPos + usedImgSize }, BAR.I18N("ui.clearMapmarks.tooltipctrl"), nil, BAR.I18N("ui.clearMapmarks.tooltip"))
	end
end
