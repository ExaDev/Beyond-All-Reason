...
local sp_GetAllUnits = Engine.Shared.GetAllUnits
local sp_GetUnitPieceMap = Engine.Shared.GetUnitPieceMap
...
local sp_WaitForScale = Engine.Synced.UnitScript.WaitForScale
