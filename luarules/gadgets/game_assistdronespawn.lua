if not (Engine.Shared.GetModOptions().assistdronesenabled == "enabled" or (Engine.Shared.GetModOptions().assistdronesenabled == "pve_only" and BAR.Utilities.Gametype.IsPvE())) then
	return
end
